...
// Windows 原生迁移补丁:default.rs(r0vm IPC prover)使用 UnixStream/OwnedFd,
// 上游未加 cfg gate 导致 Windows 编译失败。DefaultProver 仅在 bonsai/actor
// 路径使用,这里补 gate(risc0 3.0.6,本地 vendored 修复)。
#[cfg(feature = "bonsai")]
